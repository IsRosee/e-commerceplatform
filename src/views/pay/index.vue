...
const getOrderInfo = async () => {
  const res = await getOrderInfoService(id)
  payInfo.value = res.result
  //倒计时
  if (res.result.countdown > 0) {
    createCountDown(payInfo.value)
  }
}
getOrderInfo()
//跳转支付
...
const payUrl = `${baseURL}pay/aliPay?orderId=${id}&redirect=${redirectUrl}`
</script>
    ...
    <div class="container">
      ...
      <div class="pay-info">
        ...
        <div class="tip">
          <p>订单提交成功！请尽快完成支付。</p>
          <p>
            支付还剩 <span>{{ payInfo.formatTime }}</span
            >, 超时后将取消订单
          </p>
        </div>
        <div class="amount">
      ...
      <div class="pay-type">
        ...
        <div class="item">
          ...
          <!-- 默认支付宝支付 -->
          <!-- 账号：scobys4865@sandbox.com 支付、登录密码：111111 -->
