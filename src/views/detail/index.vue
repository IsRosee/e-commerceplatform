...
import { getGoodsDetailService } from '@/apis/detail'
    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <!-- goods一开始为{} categories为undefined，访问undefined[1]报错-->
          <!-- 可选链?.     ，categories有值才继续访问[1] -->
          <!-- v-if -->
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <template v-if="goodsDetail.mainPictures">
                <!-- 确保 goodsDetail.mainPictures 存在后再渲染内容 -->
                <ImageView :images="goodsDetail.mainPictures"></ImageView>
              </template>
              <!-- 统计数量 -->
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
              <XtxSku :goods="goodsDetail" @change="skuChange"></XtxSku>
              <!-- 数据组件 -->
              <el-input-number :min="1" v-model="count"></el-input-number>
              <!-- 按钮组件 -->
              <div>
